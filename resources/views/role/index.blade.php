...
<div class="container" x-data="roleForm()">
    ...
    <div class="table-title">
        <div class="row">
            ...
            <div class="col-sm-4">
                <a class="btn btn-info add-new" href="{{ url('roles/create') }}" role="button"><i class="fa fa-plus"></i> Add New</a>
            </div>
            @endif
            @endauth
        </div>
    ...
    <table class="table table-bordered table-hover">
        ...
        @foreach($roles as $role)
            ...
            <td>
                ...
                <a class="edit" title="Edit" data-bs-toggle="tooltip" href="{{ url('roles/'.$role->id.'/edit') }}"><i class="fas fa-edit">&#xE254;</i></a>
                <a class="delete" title="Delete" data-bs-toggle="tooltip" @click="deleteRole({{ $role->id }})"><i class="fas fa-trash">&#xE872;</i></a>
            </td>
            @endif
            @endauth
            </tr>
