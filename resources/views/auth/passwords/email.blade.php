                ...
                <div class="m-7">
                    @if (session('status'))
                        <div
                            ...
                            <div class="text-xl font-normal  max-w-full flex-initial">{{ session('status') }}</div>
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="mb-6">
                            <button type="submit"
                                class="w-full px-3 py-4 text-white bg-blue-500 rounded-md focus:bg-blue-600 focus:outline-none">{{ __('Send Password Reset Link') }}</button>
                        </div>
                    </form>
                </div>
            </div>
