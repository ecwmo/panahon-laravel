          ...
          <form @submit.prevent="handleFormSubmit">
            <div class="mb-3">
              ...
              <input
                ...
                name="name"
                :value="station.name"
                @input="station.name = ($event.target as HTMLInputElement).value"
              />
            ...
            <div class="flex mb-3 space-x-2">
              <div class="w-1/3">
                ...
                <input
                  ...
                  name="lat"
                  :value="station.lat"
                  @input="station.lat = ($event.target as HTMLInputElement).value"
                />
                <template v-if="errors">
              ...
              <div class="w-1/3">
                ...
                <input
                  ...
                  name="lon"
                  :value="station.lon"
                  @input="station.lon = ($event.target as HTMLInputElement).value"
                />
                <template v-if="errors">
              ...
              <div class="w-1/3">
                ...
                <input
                  ...
                  @input="station.elevation = ($event.target as HTMLInputElement).value"
                />
                <template v-if="errors">
            ...
            <div class="flex mb-3 space-x-2">
              <div class="w-2/5">
                ...
                <select
                  ...
                  @change="station.station_type = ($event.target as HTMLInputElement).value"
                >
                  <option>SMS</option>
                  <option>MO</option>
                </select>
            ...
            <div class="flex mb-3 space-x-2">
              <div class="w-2/5">
                ...
                <select
                  ...
                  @change="station.status = ($event.target as HTMLInputElement).value"
                >
              ...
              <div class="w-3/5">
                ...
                <input
                  ...
                  @change="station.date_installed = ($event.target as HTMLInputElement).value"
                />
                <template v-if="errors">
            ...
            <div class="mb-3">
              ...
              <input
                ...
                @input="station.address = ($event.target as HTMLInputElement).value"
              />
              <template v-if="errors">
            ...
            <div class="flex mb-4 space-x-2">
              <div class="w-1/2">
                ...
                <input
                  ...
                  @input="station.province = ($event.target as HTMLInputElement).value"
                />
                <template v-if="errors">
              ...
              <div class="w-1/2">
                ...
                <input
                  ...
                  @input="station.region = ($event.target as HTMLInputElement).value"
                />
                <template v-if="errors">
