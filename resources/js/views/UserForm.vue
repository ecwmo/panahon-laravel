                            ...
                            <div class="w-full flex">
                                ...
                                >
                                    <i
                                        class="fas"
                                        :class="
                                            showRoleDrpDwn ? 'fa-chevron-up' : 'fa-chevron-down'
                                        "
                                    ></i>
                                </button>
                            </div>
    ...
    setup(props) {
        ...
        const userRoleNames = computed(() =>
            userRoleIds.value.map(
                (id) => roles.value.filter((role) => role['id'] === id)[0]['name']
            )
        );
        ...
        onMounted(() => {
            ...
            if (data.value.roles) userRoleIds.value = data.value.roles.map(({ id }) => id);
        });
