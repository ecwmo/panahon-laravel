...
class CreateObservationsObservationRawTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('observations_observationraw', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('observations_observationraw');
    }
}
