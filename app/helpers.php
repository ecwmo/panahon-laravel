...
function vite_assets(): HtmlString
{
  ...
  if (strlen($subURL) > 0) $subURL = "/{$subURL}";
  ...
  return new HtmlString(<<<HTML
        <script type="module" src="{$subURL}/build/{$manifest['resources/scripts/app.ts']['file']}"></script>
        <link rel="stylesheet" href="{$subURL}/build/{$manifest['resources/scripts/app.ts']['css'][0]}">
    HTML);
}
